...
const { setETHWalletFlag, monitoringTimer } = require('./eth')
...
app.listen(8080, () => console.log(`Server is ready in on port ${8080}`))



// function confirmationTimerForEth() { 
...
//           let walletAddress  =  wallet_address.trim()
//                console.log(`${transac_id}, ${walletAddress}`)
...
//   })
// }
// setInterval(confirmationTimerForEth, 30000)
